...
export default function Navbar() {
  ...
  // portal root — document.body, available only client-side
  useEffect(() => {
    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          backgroundColor: 'rgba(15, 17, 28, 0.55)',
  ...
  return (
    <>
      ...
      {/* Portal modal — renders on document.body, escapes all stacking contexts */}
      {modal}
    </>
  )
}
